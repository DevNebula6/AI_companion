...
void main() {
  group('Message JSON Parsing Tests', () {
    test('should parse JSONB array message format', () {
      final json = {
        'id': 'test-id',
    ...
    test('should parse single fragment message', () {
      final json = {
        'id': 'test-id',
        'message': ['Hello, this is a single fragment'],
        'user_id': 'user123',
        'companion_id': 'companion123',
        'conversation_id': 'conv123',
        'is_bot': false,
      ...
      expect(message.messageFragments, ['Hello, this is a single fragment']);
      expect(message.message, 'Hello, this is a single fragment');
    ...
    test('should serialize to JSONB array format', () {
